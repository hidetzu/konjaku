...
import {
  ...
  WD, wdItem, WD_SHIBUYA, stubWikidata, XSS, notRun,
  shownAsText, photoFrames, waitStrip, LIES, RE_ESC, G1_MARK,
  G1_HEAD, VERDICT_SENTENCE, pngOf, photoPng, ERA_TILE_IDS, timelineSettled,
  stepLabels, peelReady, settleAfterCondition, waited, settleAfterClick, settleAfterScroll,
  LFC_ROUTE, DEM_ROUTE, must, provText
} from "./lib.mjs";
