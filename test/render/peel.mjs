...
import {
  ...
  UNSURVEYED, YUMENOSHIMA, KIYOSUMI, UENO, NIIGATA, URAYASU,
  openGroups, suggestionsOf, rowsOf, groupsOf, WEB_SEARCH, WD,
  wdItem, WD_SHIBUYA, stubWikidata, XSS, notRun, shownAsText,
  photoFrames, waitStrip, LIES, RE_ESC, G1_MARK, G1_HEAD,
  VERDICT_SENTENCE, pngOf, photoPng, ERA_TILE_IDS, timelineSettled, stepLabels,
  peelReady, settleAfterCondition, waited, settleAfterClick, settleAfterScroll, LFC_ROUTE,
  DEM_ROUTE, must, provText
} from "./lib.mjs";
...
export const CASES = [
  ...
  ...FRESH_CASES,
  // ---- 狭い幅の器と、⚠ 建物を待つあいだ ----
  // ⚠ **ここにあった見出しは `検索の入口` だった**（2026-08-27。hidetzu/konjaku#277 の 22 本目で直した）。
  //   ⚠ **住所検索の話**だが、⚠ **`/peel` から検索は外してある**（2026-08-18）。
  //   ⚠ **`peel.mjs` に検索のケースは 0 件**（⚠ 機械で確認）。⚠ **中身が消えた見出しだった。**
  //   ⚠ **下の 2 件は、⚠ どちらも検索と無関係。**⚠ **その 2 件に合う名前へ付け直す。**
  {
