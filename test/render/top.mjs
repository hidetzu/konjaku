...
import {
  WORDS, PORT, BASE, OUT, TOYOSU,
  NAGOYA_LL, KARUIZAWA, NIIGATA,
  URAYASU, suggestionsOf, rowsOf,
  waitVerdict, WD, wdItem, stubWikidata, waitStrip,
  LIES, RE_ESC, G1_MARK, G1_HEAD, VERDICT_SENTENCE,
  ...
  waitOptional, settleAfterClick, settleAfterScroll, LFC_ROUTE,
