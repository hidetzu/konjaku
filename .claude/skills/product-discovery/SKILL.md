...
⚠ **捨てる判断をしたことが読めない Discovery は、⚠ Discovery ではない**（[ADR 0037](../../../docs/adr/0037-Discoveryは案を出すより先に案を捨てる.md)）。
...
⚠ **大事なのは「落とした案が何件あるか」ではない。**
⚠ **「捨てる判断を、⚠ 実際にやったこと」が読めること。**

⚠ **落とす案が無かったなら `なし` でよい。**⚠ **ただし、⚠ なぜ無かったかを書く。**
...
- MUST NOT: ⚠ **数を埋めるために、⚠ 落とすつもりのない案を並べて落とさない**
  （⚠ **候補の水増しと同じ病**。⚠ **やった風に見せるのが、いちばん悪い**）
- MUST NOT: ⚠ **`なし` とだけ書いて理由を書かない**（⚠ **判断したのか、⚠ しなかったのかが読めない**）
...
⚠ **`Rejected` は `なし` でもよい。**⚠ **ただし理由を書く**（§6）。⚠ **`Next Step` は 1 つに絞る。**
