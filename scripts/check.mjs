...
//     ② 表より多い   … 増やした（棚卸しを通さずに内部語が増えた）
{
  ...
  const SCREEN_WORDS = [
    ...
    { word: "根拠あり", kind: "分類", live: 2, next: "#9c",
      files: ["index.html", "words.js"],
      seat: "words.js の TAG.own（⚠ **字の持ち主**）と、根拠パネルのバッジ「自前・根拠あり」（そちらは #9d）" },
    { word: "この土地から", kind: "分類", live: 1, next: "#9c",
      files: ["words.js"], seat: "words.js の TAG.why（一覧行のタグ）" },
    { word: "外部↗", kind: "分類", live: 1, next: "#9c",
      files: ["words.js"], seat: "words.js の TAG.ext。⚠ 既定値もここ 1 つ（以前は呼ぶ側にも写しがあった）" },
