...
//     オーナー判断で許容。⚠ 事前計算へ寄せる案が別途ある（tmp/9 の設計メモ）。
...
function headHTML(){
  ...
  //   ⚠ **足したぶんは写真の上限から出した**（下の #big の 31.5rem）。
