...
(function (g) {
  ...
  // ⚠ **遠すぎる候補を出さないための安全弁。** これより遠い境目は出さない。
  //   ⚠ **測って出した値ではない。**⚠ **決めた値**（2026-09-05。Owner 判断）。
  //
  // ⚠ **測った事実**（2026-09-05）: ⚠ **31 点で、⚠ 1 度も効いていない。**
  //     24 地点（都市に偏る）   9〜283m
  //     14 点（無作為・480 点打って区分が在ったもの） 9〜260m ／ 中央 68m ／ p90 255m
  //   ⚠ **どちらも 600m を 1 件も超えなかった。**
  //   ⚠ **効いていないので変えないが、⚠ 「実測から導いた」とは言わない。**
  //   ⚠ **回し方は `scripts/survey-border.mjs`。**
  const 上限m = 600;
